...
function createErrorHandler(formData) {
  ...
  if ((0, _utils.isObject)(formData)) {
    return Object.keys(formData).reduce(function (acc, key) {
      return _objectSpread({}, acc, (0, _defineProperty2.default)({}, key, createErrorHandler(formData[key])));
    }, handler);
  }

  if (Array.isArray(formData)) {
    return formData.reduce(function (acc, value, key) {
      return _objectSpread({}, acc, (0, _defineProperty2.default)({}, key, createErrorHandler(value)));
    }, handler);
  }
...
function unwrapErrorHandler(errorHandler) {
  return Object.keys(errorHandler).reduce(function (acc, key) {
    if (key === "addError") {
      ...
      return _objectSpread({}, acc, (0, _defineProperty2.default)({}, key, errorHandler[key]));
    }

    return _objectSpread({}, acc, (0, _defineProperty2.default)({}, key, unwrapErrorHandler(errorHandler[key])));
  }, {});
}
/**
